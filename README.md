...
<img alt='func3.1' src='./README_IMG/포트홀지도_1.PNG'>

- 확인 가능 데이터 : 탐지된 포트홀 위치
- 기능
  1. 마커를 통해 포트홀 위치를 지도에서 확인 가능
    - 자율 주행 차량으로 탐지된 포트홀 위치 표시

<p style='font-size:16px;'>3.2 포트홀 보수 작업 지시</p>

3.2.1 포트홀 지도를 통한 작업지시
<img alt='func3.2' src='./README_IMG/포트홀작업지시_1-1.PNG'>
- 확인 가능 데이터 : 탐지된 포트홀 이미지, 포트홀의 위치, 좌표, 시각, 연계 전 후 상태
- 기능
  1. 마커를 통한 작업 연계 작업 제공
    - 포트홀 마커 선택 후 작업 지시하기 버튼을 통한 작업 지시 

3.2.2 연계 내역 페이지를 통한 작업지시
<img alt='func3.2' src='./README_IMG/포트홀작업지시_2_1.PNG'>
<img alt='func3.2' src='./README_IMG/포트홀작업지시_2_2.PNG'>
<img alt='func3.2' src='./README_IMG/포트홀작업지시_2_3.PNG'>

- 확인 가능 데이터 : 탐지된 포트홀 이미지, 발견 시각, 주소, 위치, 연계 상태
- 기능
  1. 연계 내역 페이지를 통한 작업 연계 작업 제공
    - 리스트 목록 선택 후 작업 지시하기 버튼을 통한 작업 지시
  2. 잘 못 탐지된 포트홀 삭제 버튼 구현
    - 삭제하기 버튼을 통해 더 효율적인 포트홀 정보 관리


<p style='font-size:16px;'>3.3 포트홀 보수 작업 경로 생성</p>

<img alt='func3.3' src='./README_IMG/보수작업_2.PNG'>
<img alt='func3.3' src='./README_IMG/보수작업.PNG'>


- 확인 가능 데이터 : 작업 가능한 마커 위치, 작업 경로
- 기능
  1. 작업 지시된 포트홀 목록 확인
    - 작업 구역에 한정된 포트홀 목록 리스트 (ex. 광산구 유지보수팀은 광산구 작업 내용만 확인 가능)
    - 목록 숨기기 버튼을 통해 개선된 UI/UX 구현
  2. 작업 경로 확인
    - 마커의 위치를 선택해 작업 경로 확인 가능
  3. 작업 상태 관리
    - 시작 버튼을 선택해 작업 상태 변환

<p style='font-size:16px;'>3.4 포트홀 보수 작업 모니터링</p>
3.4.1 유지 보수팀 페이지를 통한 작업 모니터링
<img alt='func3.4' src='./README_IMG/보수작업모니터링_1.PNG'>
<img alt='func3.4' src='./README_IMG/보수작업모니터링_2.PNG'>
<img alt='func3.4' src='./README_IMG/보수작업모니터링_3.PNG'>

- 확인 가능 데이터 : 작업 위치, 연계 시각, 연계 상태
- 기능
  1. 작업 상태 확인
    - 작업 전, 후 데이터들을 분별하여 확인
    - 상세보기 기능
  2. 작업 상태 변경
    - 작업 전 리스트에서 시작하기 버튼을 눌러 작업 중으로 상태 변경 가능
    - 작업 중 리스트에서 보수완료 버튼을 눌러 작업 완료로 상태 변경 가능

3.4.2 유지 보수팀 페이지를 통한 작업 모니터링
<img alt='func3.4' src='./README_IMG/운영관리과_1.PNG'>
<img alt='func3.4' src='./README_IMG/운영관리과_2.PNG'>
<img alt='func3.4' src='./README_IMG/운영관리과_3.PNG'>

- 확인 가능 데이터 : 작업 상태 별 리스트, 주소, 연계 부서, 수리시각
- 기능
  1. 유지보수 작업 상태 확인
    - 작업 전, 중, 후 데이터들을 분별하여 확인
    - 상세보기 기능
