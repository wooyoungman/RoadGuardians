    ...
    const fetchData = async () => {
      try {
        const [beforeResponse, duringResponse, doneResponse] = await Promise.all([
          ...
          axios.get('http://i11c104.p.ssafy.io/api/v1/repair?status=ondoing'),
          axios.get('http://i11c104.p.ssafy.io/api/v1/repair?status=complete'),
        ]);
        ...
        <div className={`offcanvas ${showOffcanvas ? 'show' : ''}`}>
          <div className="offcanvas-body">
            <div className="flex justify-between items-center mb-4">
              <h5 className="text-xl font-semibold">상세 정보</h5>
